...
public class RemoteFilesTasklet implements Tasklet, InitializingBean
{
    private Logger logger = LoggerFactory.getLogger(RemoteFilesTasklet.class);
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception
    {
    	...
    	deleteLocalFiles();
    	//System.out.println("file length::"+remoteDirectory.length());
    	if(remoteDirectory.isEmpty())
          chunkContext.getStepContext().getStepExecution().setExitStatus(new ExitStatus("FileExists"));
        ...
        if (retryIfNotFound)
        {
            ...
            {
            	 chunkContext.getStepContext().getStepExecution().setExitStatus(new ExitStatus("FileNotFound"));
